...
\begin{titlepage}
  ...
  \begin{tabular}{rl}
    ...
    DOI:            & \href{https://doi.org/10.5281/zenodo.19909665}{10.5281/zenodo.19909665}\\
  ...
  Hash SHA-256 del paquete fuente: véase
  \texttt{indautor/VERSION-REGISTRADA.pdf}\\
  (autoritativo, fuera del ZIP para evitar circularidad de hash).\\
  DOI Zenodo: \href{https://doi.org/10.5281/zenodo.19909665}{10.5281/zenodo.19909665}
  \vfill
\end{titlepage}
...
\begin{tabularx}{\linewidth}{lX}
  ...
  DOI (Zenodo) & \href{https://doi.org/10.5281/zenodo.19909665}{10.5281/zenodo.19909665} \\
  Repositorio público & \url{https://github.com/yoyontzin/padicmidi} \\
  \bottomrule
\end{tabularx}
...
\begin{tabularx}{\linewidth}{lX}
  ...
  Tamaño y SHA-256   & Reportados de manera autoritativa en
                       \code{indautor/VERSION-REGISTRADA.pdf} y en
                       \code{indautor/manifiesto-archivos.pdf} (ambos
                       distribuidos fuera del ZIP, lo que evita la
                       circularidad de hash inherente a inscribir el SHA
                       del ZIP dentro de un archivo del propio ZIP). \\
  DOI Zenodo         & \href{https://doi.org/10.5281/zenodo.19909665}{10.5281/zenodo.19909665} \\
  \bottomrule
\end{tabularx}
