...
P-ADAGIO — *P-adic Arithmetic, Dynamics And Galois-Informed Observations*

## Funding

Research supported by SECIHTI (Mexico), grant number CF-2019/217367.

## Acknowledgements

The author thanks the Centro de Investigación en Matemáticas (CIMAT, Mérida) for institutional support, and the Mutopia Project for providing CC-licensed MIDI files used as benchmark corpus.
